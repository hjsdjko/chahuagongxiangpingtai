        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.chahuaName" type="text" v-model="ruleForm.chahuaName" placeholder="插画名称"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="chahuaPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                          class="title">插画图片</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.chahuaPhoto" :src="ruleForm.chahuaPhoto" mode="aspectFill">
                        </image>
                        <image  :style='{"width":"68rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"68rpx"}'
                                class="avator" v-else src="../../static/gen/upload.png" mode="aspectFill"></image>
					                ...
					                <view
                        :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(218, 220, 219, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"108rpx"}'
                        class="cu-form-group" @tap="chahuaFileTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                          class="title">下载</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                :style='{"width":"68rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"68rpx"}'
                                class="avator" v-if="ruleForm.chahuaFile" :src="ruleForm.chahuaFile" mode="aspectFill">
                        </image>
                        <image  :style='{"width":"68rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","borderRadius":"100%","textAlign":"left","height":"68rpx"}'
                                class="avator" v-else src="../../static/gen/upload.png" mode="aspectFill"></image>
                    </view>
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                          class="title">插画类型</view>
                    <picker @change="chahuaTypesChange" :value="chahuaTypesIndex" :range="chahuaTypesOptions" range-key="indexName">
                        <view
                                :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"16rpx","color":"#008761","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.chahuaTypes?ruleForm.chahuaValue:"请选择插画类型"}}</view>
                    </picker>
                </view>
                <view
                        :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
...
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"16rpx","color":"#008761","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.chahuaContent" v-model="ruleForm.chahuaContent" placeholder="插画详情"/>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let chahuaTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'chahua_types',
            }
			let chahuaTypes = await this.$api.page(`dictionary`, chahuaTypesParams);
			this.chahuaTypesOptions = chahuaTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`chahua`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.chahuaId){
                this.ruleForm.chahuaId = options.chahuaId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            // 下拉变化
            chahuaTypesChange(e) {
                this.chahuaTypesIndex = e.target.value
                this.ruleForm.chahuaValue = this.chahuaTypesOptions[this.chahuaTypesIndex].indexName
                this.ruleForm.chahuaTypes = this.chahuaTypesOptions[this.chahuaTypesIndex].codeIndex
            },
			...
			chahuaPhotoTap() {
                ...
                this.$api.upload(function(res) {
                    _this.ruleForm.chahuaPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
			...
			chahuaFileTap() {
                let _this = this;
                this.$api.upload(function(res) {
                    _this.ruleForm.chahuaFile = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.chahuaName)) {
                    this.$utils.msg(`插画名称不能为空`);
                    return
                }
				if ((!this.ruleForm.chahuaPhoto)) {
                    this.$utils.msg(`插画图片不能为空`);
                    return
                }
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`chahua`, this.ruleForm);
                } else {
                    await this.$api.save(`chahua`, this.ruleForm);
                }
